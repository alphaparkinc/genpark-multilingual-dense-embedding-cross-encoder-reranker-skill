# genpark-multilingual-dense-embedding-cross-encoder-reranker-skill
...
> **GenPark AI Agent Skill** -- Multilingual dense embedding vectorizer and cross-encoder neural reranker (Cohere style)
